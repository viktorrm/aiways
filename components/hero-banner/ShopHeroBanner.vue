<template>
  <section class="slider__area">
    <swiper class="slider__active slider__active-13 swiper-container" :slidesPerView="1" :spaceBetween="0" :effect="'fade'" :modules="modules">
      <swiper-slide v-for="item in slider_data" :key="item.id" class="slider__item-13 slider__height-13 grey-bg-17 d-flex align-items-end">
        <div class="container">
          <div class="row align-self-end">
            <div class="col-xl-6 col-lg-6">
              <div class="slider__content-13">
                <span class="slider__title-pre-13" v-html="item.pre_title"> </span>
