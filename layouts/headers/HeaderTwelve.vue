<template>
  <header>
    <div :class="`header__area ${style_2 ? '' : 'header__transparent'}`">
      <div
        :class="`header__bottom-13 header__padding-7 header__black-3 header__bottom-border-4
      ${style_2 ? 'header__bottom-13-white' : 'grey-bg-17'} header__sticky ${
          ...
          <div class="mega-menu-wrapper p-relative">
            <div class="row align-items-center">
              <div class="col-xxl-1 col-xl-2 col-lg-4 col-md-4 col-sm-5 col-8">
                <div class="logo">
                  <nuxt-link href="/">
                    <img src="~/assets/img/logo/aiways-logo.svg" alt="logo" />
                  </nuxt-link>
                </div>
              </div>
              ...
              <div class="col-xxl-5 col-xl-3 col-lg-8 col-md-8 col-sm-7 col-4">
                <div
                  class="header__bottom-right-13 d-flex justify-content-end align-items-center pl-30"
                >
